...
public class XpathHelper
{
    ...
    public static final String HINT_TEXT_BOX = "//label[text()='%s']/parent::div/following-sibling::div//input";
    public static final String DROPDOWN = "//label[text()='%s']/parent::div/following-sibling::div//div[@class='oxd-select-text-input']";
    public static final String CANCEL_OR_RESET_BUTTON = "//button[@type='button' and text()=' %s ']";
